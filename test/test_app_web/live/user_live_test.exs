defmodule TestAppWeb.UserLiveTest do
  use TestAppWeb.ConnCase

  import Phoenix.LiveViewTest
  import TestApp.DiaryFixtures

  @create_attrs %{age: 42, meta: "some meta", name: "some name"}
